...
\subsection{One-Dimensional Model}
	\Cref{fig:results:1D:U,fig:results:1D:C} presents the results of the experiments with the one-dimensional model. The data these plots are based on can be found in \cref{a:results1D} in \crefrange{tab:results:1D:10:1000}{tab:results:1D:1000:10000}.
