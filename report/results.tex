...
\begin{figure}
	...
	\end{subfigure}		
	\caption{The \subref{fig:results:2D:averageEnergy} average energy, \subref{fig:results:2D:specificHeat} specific heat and \subref{eq:experiment:2D:averageMagnetization} per spin in a 2D Ising model for $\dimensionality = 10, 50, 100$ and $\numberOfSamples = 1000, 10000$.}
