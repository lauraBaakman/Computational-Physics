...
\Cref{s:method} discusses how the Metropolis Monte Carlo method was used to solve the Ising model. In \cref{s:experiment} the run experiments are introduced, their results are presented in \cref{s:results}. \Cref{s:discussion} discusses the found results and \cref{s:conclusion} concludes this paper.