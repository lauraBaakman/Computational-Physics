...
\label{app:implementation:simulation}
	...
	\lstinputlisting[label={lst:simulation:randconfig}]{./../code/generateRandomConfiguration.m}
...
\label{app:implementation:statistics}
	...
	\lstinputlisting[label={lst:statistics:computeMagnetization}]{./../code/computeMagnetization.m}
